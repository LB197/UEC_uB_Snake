...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: vga_drawrect_char_0, and set properties
	set vga_drawrect_char_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:vga_drawrect_char:1.0 vga_drawrect_char_0 ]
	...
	# Connect all clock & reset of vga_drawrect_char_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins vga_drawrect_char_0/S_AXI_CHAR_CTRL]
	connect_bd_net [get_bd_pins vga_drawrect_char_0/s_axi_char_ctrl_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins vga_drawrect_char_0/s_axi_char_ctrl_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins vga_drawrect_char_0/S_AXI_TEXT_MEM]
	connect_bd_net [get_bd_pins vga_drawrect_char_0/s_axi_text_mem_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins vga_drawrect_char_0/s_axi_text_mem_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to vga_drawrect_char_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/vga_drawrect_char_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_vga_drawrect_char_0_S_AXI_CHAR_CTRL_* ]]
	puts $fp "set s_axi_char_ctrl_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_vga_drawrect_char_0_S_AXI_TEXT_MEM_* ]]
	puts $fp "set s_axi_text_mem_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:vga_drawrect_char:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/vga_drawrect_char_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "vga_drawrect_char_v1_0_hw_${i}"
